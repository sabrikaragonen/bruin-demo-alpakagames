...
(
    ...
    from `analytics_504624180.events_*`
    where replace(_TABLE_SUFFIX, 'intraday_', '') between '20260101' and '20260131'
...
(
    select 
        ...
        array_agg(distinct p.value.string_value limit 3) as example_str_values,
        array_agg(distinct p.value.int_value limit 3) as example_int_values,
        array_agg(distinct p.value.float_value limit 3) as example_float_values,
